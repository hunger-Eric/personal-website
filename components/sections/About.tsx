...
function getCapabilities(locale: "zh" | "en"): Capability[] {
  if (locale === "zh") {
    return [
      {
        title: "AI 工作流工程",
        description: "使用 Codex、Claude Code 与多模型协同，把 AI Native 开发工作流接进原型、产品迭代和内容整理。",
        Icon: GitBranch,
      },
      {
        title: "自动化系统",
        description: "基于 Docker、n8n、API 与自动化流程，搭建长期可维护的业务自动化系统。",
        Icon: Workflow,
      },
      {
        title: "知识库与 RAG 系统",
        description: "构建本地知识库、RAG 与多源检索系统，让 AI 能真正连接业务资料、文档和内容资产。",
        Icon: BrainCircuit,
      },
      {
        title: "AI 辅助创作",
        description: "结合 AI 与视觉表达，整理素材、生成内容方案，并把创意流程沉淀成可重复执行的系统。",
        Icon: Layers3,
      },
    ];
  }
  ...
  return [
    {
      ...
      description: "I connect Codex, Claude Code, and multi-model workflows to prototyping, product iteration, and content operations.",
      Icon: GitBranch,
    },
    {
      title: "Automation Systems",
      description: "I build maintainable automation systems with Docker, n8n, APIs, and operational workflows.",
      Icon: Workflow,
    },
    {
      title: "Knowledge & RAG Systems",
      description: "I design local knowledge bases, RAG flows, and multi-source retrieval so AI can work with real business context.",
      Icon: BrainCircuit,
    },
    {
      title: "AI-assisted Creative Production",
      description: "I connect AI with visual thinking, content structure, and reusable creative production workflows.",
      Icon: Layers3,
    },
  ];
}
            ...
            <div>
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                {capabilities.map(({ title, description, Icon }) => (
                  <article key={title} className="rounded-xl border border-border bg-card/70 p-4">
