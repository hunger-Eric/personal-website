...
vi.mock("@/lib/site-url", () => ({ DEFAULT_SITE_URL: "https://me.itheheda.online", SITE_URL: "http://localhost:3000" }));
...
describe("AdminArticlesPage", () => {
  it("restores a valid requested run and ignores invalid IDs", async () => {
    ...
    expect(valid.props.defaultSourceUrl).toBe("https://me.itheheda.online");
    getRun.mockClear();
