...
export default async function ArticlesPage(){const articles=await getArticles();const items:ArticleListItem[]=articles.map(a=>({slug:a.slug,title:a.title,summary:a.summary,date:a.date,category:a.category,tags:a.tags,featured:a.featured,imageSrc:a.imageSrc,imageAlt:a.imageAlt,readingTime:a.readingTime,author:a.author,chapter:a.chapter,publicPath:a.publicPath}));return <ArticlesPageClient articles={items}/>}
